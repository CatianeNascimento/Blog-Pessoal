	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Catiane Nascimento").url("https://github.com/CatianeNascimento")
								.email("csnascimento07@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github")
						.url("https://github.com/CatianeNascimento/Blog-Pessoal"));
	}
